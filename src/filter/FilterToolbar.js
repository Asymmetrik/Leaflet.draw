L.FilterToolbar = L.Class.extend({
	...
	addToolbar: function (map) {
		...
		this._toolbarContainer = L.DomUtil.create('div', 'leaflet-draw-toolbar leaflet-bar leaflet-filter-toolbar');
		this._map = map;
